...
// ‼️Une seule erreure et le cache ne sera pas actif, il sera vide  ‼️
// ‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️‼️
//Avoir le même n° de version dans le manifest et le SW
const version = 1.1;

//Url qu'on doit mettre dans le cache
const urlsToCache = [
    "/",
    "/index.html",
    "/style.css",
...
self.addEventListener("install", (e) => {
    ...
    //On va ajouter les urls dans le cache
    e.waitUntil(
    ...
    caches.match(e.request).then((cached) => {
      ...
      return fetch(e.request)
        ...
        .catch(() => {
          ...
          // on renvoie l'index de la SPA (single page application) pour avoir un fallback hors-ligne.
